...
namespace SpatialDataManagement
{
    ...
    /// </summary>
    [Guid("119c359a-6b40-4ef5-b8d3-6746ad9716cd")]
    [ClassInterface(ClassInterfaceType.None)]
    [ProgId("SpatialDataManagement.TurnAllLayersOffCmd")]
    public sealed class TurnAllLayersOffCmd : BaseCommand
    {
        ...
        public TurnAllLayersOffCmd()
        {
            ...
            base.m_caption = "所有图层不可见";
            base.m_message = "所有图层不可见";
            base.m_toolTip = "所有图层不可见";
            base.m_name = "TurnAllLayersOffCmd";
